...
# X Y Filter
    ...
    def update_angles(i, ytarg, xtarg):
        ...
        # print( i, ytarg, xtarg,coordinates[i][0], coordinates[i][1], coordinates[3][0], coordinates[3][1], ptheta[i])
    ...
    print("%d,%d,%d,%d,%d,%d,%d" %(data_out[0], data_out[1],data_out[2],data_out[3],data_out[4],data_out[5],data_out[6]) )
